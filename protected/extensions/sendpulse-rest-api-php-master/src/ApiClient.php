...
class ApiClient implements ApiInterface
{
    ...
    private function getToken()
    {
        ...
        if (200 !== $requestResult->http_code) {
            return false;
        }
     ...
     * @return stdClass
     */
    private function sendRequest($path, $method = 'GET', $data = [], $useToken = true)
    {
        ...
        if (401 === $headerCode && 0 === $this->refreshToken) {
            ++$this->refreshToken;
            $this->getToken();
