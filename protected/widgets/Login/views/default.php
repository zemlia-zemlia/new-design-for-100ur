        ...
        <div class="profile-block-container flat-panel inside">
            <div class="row">
                ...
                <div class="col-sm-8 col-xs-6">
                        <div>
                        <?php echo CHtml::link(('' != Yii::app()->user->lastName) ? Yii::app()->user->shortName : CHtml::encode(Yii::app()->user->name), Yii::app()->createUrl((User::ROLE_BUYER == Yii::app()->user->role) ? '/cabinet' : '/user')); ?>
