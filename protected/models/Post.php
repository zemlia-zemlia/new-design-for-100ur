...
class Post extends CActiveRecord
{
    ...
    public function relations(): array
    {
        return [
            ...
            'commentsCount' => [self::STAT, Comment::class, 'objectId', 'condition' => 'type=' . Comment::TYPE_POST . ' AND status!=' . Comment::STATUS_SPAM],
            'author' => [self::BELONGS_TO, User::class, 'authorId'],
            'ratingHistory' => [self::HAS_MANY, PostRatingHistory::class, 'postId'],
            'viewsCount' => [self::HAS_ONE, Postviews::class, 'postId'],
            'categories' => [self::MANY_MANY, Postcategory::class, '{{post2cat}}(postId, catId)'],
        ];
    }
