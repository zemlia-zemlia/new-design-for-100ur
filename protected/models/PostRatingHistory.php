...
/**
 * This is the model class for table "{{postRatingHistory}}".
 *
...
class PostRatingHistory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('postId, userId, delta', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('postId, userId, delta, datetime', 'safe', 'on'=>'search'),
		);
	}
