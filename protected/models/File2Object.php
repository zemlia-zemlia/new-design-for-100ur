...
class File2Object extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('file_id, object_id, object_type', 'required'),
			array('file_id, object_id, object_type', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, file_id, object_id, object_type', 'safe', 'on'=>'search'),
		);
	}
