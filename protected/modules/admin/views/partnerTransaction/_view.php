...
<tr id="request-id-<?php echo $data->id;?>">
    ...
    <td>
        ...
        id: <?php echo CHtml::link($data->partner->id, Yii::app()->createUrl('admin/user/view', array('id' => $data->partner->id)));?><br />
        <small><i><span class="text-muted"><?php echo CustomFuncs::niceDate($data->datetime);?></span></i></small>
