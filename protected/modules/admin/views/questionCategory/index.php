...
<div class="box">
    <div class="box-body">
        <h2>Категории вопросов
            <?php echo CHtml::link('Добавить категорию', Yii::app()->createUrl('/admin/questionCategory/create'), ['class' => 'btn btn-primary']); ?>
            <?php echo CHtml::link('Ссылки на активные категории', Yii::app()->createUrl('/admin/questionCategory/showActiveUrls/'), ['class' => 'btn btn-default']); ?>
            <?php echo CHtml::link('Иерархия всего раздела категорий', Yii::app()->createUrl('/admin/questionCategory/indexHierarchy/'), ['class' => 'btn btn-default']); ?>
