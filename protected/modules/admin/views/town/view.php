...
<table class="table table-bordered">
    ...
    <tr>
        ...
        <td>
            <?php if ('' != $model->photo):?>
                <?php echo CHtml::image($model->getPhotoUrl(), $model->name, ['class' => 'img-responsive']); ?>
                <p><br />
                    <?php echo CHtml::link('Удалить фото', Yii::app()->createUrl('/admin/town/removePhoto', ['id' => $model->id]), ['class' => 'btn btn-danger']); ?>
                </p>
            <?php endif; ?>
        </td>    
    </tr>
...
<?php echo CHtml::link('Редактировать', Yii::app()->createUrl('/admin/town/update', ['id' => $model->id]), ['class' => 'btn btn-primary']); ?>
