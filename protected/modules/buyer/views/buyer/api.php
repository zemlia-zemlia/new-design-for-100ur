...
<p class="lead">Данное API дает возможность отправлять статусы лидов купленных у нас, например вы сможете делать отбраковку лида в автоматическом режиме прямо из вашей crm системы. </p>
