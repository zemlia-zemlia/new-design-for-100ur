...
$this->setPageTitle($userStatusName . $userDisplayName . '. Город ' . $model->town->name . '. ');
        ...
        <div class="container-fluid vert-margin30">
            <div class="row">
                <div class="col-sm-3 center-align">
                    ...
                    <?php echo CHtml::link('Задать вопрос', Yii::app()->createUrl('question/create'), ['class' => 'btn btn-info']); ?>
                ...
                <div class="col-sm-9">
                    ...
                    <p>
                        <strong>Сайт:</strong> <?php echo CHtml::link(CHtml::encode($model->settings->site), $model->settings->site, ['target' => '_blank']); ?>
                    </p>
                    <?php endif; ?>
...
<?php foreach ($questions as $question):?>
    <div class="row question-list-item <?php if (1 == $question['payed']):?> vip-question<?endif; ?>">
        <div class="col-sm-12">
			...
			<small>
                ...
                ?>
                <?php echo CHtml::link(CHtml::encode(CustomFuncs::mb_ucfirst($question['title'])), Yii::app()->createUrl('question/view', ['id' => $question['id']])); ?>
			</small>
            </p>
        </div>
    </div>
