...
<div class="form">
    ...
    <p class="text-muted small center-align">
        ...
        Размещение в тексте ответа рекламы, Email, телефонов ЗАПРЕЩЕНО!<br/> Также запрещается полное или частичное копирование текста ответов с других ресурсов.<br/> Свои контактные данные указывайте в профиле и ссылайтесь на них в своих ответах.
    </p>
